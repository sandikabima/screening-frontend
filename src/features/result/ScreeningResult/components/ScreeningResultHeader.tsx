...
import { PriorityResult } from "../types/screeningResult.types";
...
export const ScreeningResultHeader: React.FC<ScreeningResultHeaderProps> = ({
  search,
  priorityFilter,
  loading = false,
  onSearchChange,
    ...
    <div className="bg-black/90 p-4 border border-zinc-900 rounded-lg space-y-3 font-mono select-none">
      <div className="flex flex-wrap items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-2">
          <Tooltip text="Muat Ulang Data Logs">
            <Button
              variant="secondary"
              size="md"
              onClick={onRefresh}
