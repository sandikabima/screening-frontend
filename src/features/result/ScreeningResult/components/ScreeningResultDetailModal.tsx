      ...
      <head>
        ...
        <style>
          ...
          * { box-sizing: border-box; -webkit-print-color-adjust: exact !important; print-color-adjust: exact !important; }
          ...
          .report-container { max-width: 190mm; margin: 0 auto; }
          ...
          .signature-container { display: flex; width: 100%; margin-top: 8px; border: 1px solid #cbd5e1; border-radius: 3px; min-height: 120px; }
