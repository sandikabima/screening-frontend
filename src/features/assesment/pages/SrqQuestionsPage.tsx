...
export const SrqQuestionsPage: React.FC = () => {
  const {
    questions,
    loading,
    submitting,
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-zinc-900 pb-5">
        <div>
          <h1 className="flex items-center gap-3 text-xl font-black uppercase tracking-wider text-white">
            <span className="h-2.5 w-2.5 shrink-0 animate-pulse rounded-full bg-red-600 shadow-[0_0_10px_#2563eb]" />
            MANAJEMEN KUESIONER SRQ-20 (WHO)
          </h1>
          <p className="mt-1 text-xs text-zinc-500">
            Direktori 20 Pertanyaan Baku Self-Reporting Questionnaire dari WHO
          </p>
        </div>

        <div className="flex items-center gap-3">
          <div className="px-3.5 py-1.5 bg-black border border-zinc-900 rounded-lg text-xs">
            <span className="text-zinc-500 uppercase">TOTAL SRQ: </span>
...
export default SrqQuestionsPage;
